<?php 
	...
	if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
		...
		$cartTotal = '<p class="p_total"><span>Basket Total</span> : LKR<span id="cart-total">'.$cartTotal.'</span></p>';
...
<div class="footer_parallax" onclick="remove_class()">
	...
	<div class="on_footer_parallax">
		...
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>Lanka Food Restaurant</span>. All Rights Reserved</p>
