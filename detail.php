			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc price">Price:</span> LKR <span id="price"><?php echo $price; ?></span></p>
						...
						<p><span class="bold_desc">Total Price:</span> LKR <span id="total_price"><?php echo $price; ?></span></p>
...
<div class="footer_parallax" onclick="remove_class()">
	...
	<div class="on_footer_parallax">
		...
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>Lanka Foods Restaurant</span>. All Rights Reserved</p>
